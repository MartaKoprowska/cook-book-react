            ...
            <div>
                <div className="row">
                    <div className="col s12">
                        <h3>Pomysły na śniadania i kolacje</h3>
                    </div>
                    <div className="col s12">
                        <div className="collection">
                            <ul className="recipeList">
                                {this.state.breakfast.map((item, index) => {
                                    ...
                                    if (item.type === "śniadanie" || item.type === "kolacja" ) {
                                        return (
                                            <li className="collection-item " key={index}>
                                                <div className="row">
                                                    <div className="grid-example col s12 m7 ">
                                                        ...
                                                        <Link className="waves-effect waves-light btn" to={"/sniadanie/"+ item.id}>Zobacz więcej</Link>
                                                    </div>
